...
export const TOOL_MANIFESTS = {
  memory: {
    ...
    tools: {
      ...
      crow_get_context: { params: "include_dynamic?, platform?", desc: "Generate crow.md context" },
      crow_update_context_section: { params: "section_key, content?, section_title?, enabled?, sort_order?", desc: "Update crow.md section" },
      crow_add_context_section: { params: "section_key, section_title, content, sort_order?", desc: "Add crow.md section" },
      crow_list_context_sections: { params: "", desc: "List crow.md sections" },
      crow_delete_context_section: { params: "section_key", desc: "Delete crow.md section" },
    },
  },

  research: {
    displayName: "Research",
    description: "Research pipeline: projects, sources with auto-APA citation, notes, bibliography, search, and verification",
    tools: {
      crow_create_project: { params: "name, description?, tags?", desc: "Create research project" },
      crow_list_projects: { params: "status?, limit?, offset?", desc: "List projects" },
      crow_update_project: { params: "id, name?, description?, status?, tags?", desc: "Update project" },
      crow_add_source: { params: "title, source_type, project_id?, url?, authors?, publication_date?, publisher?, doi?, isbn?, abstract?, content_summary?, full_text?, citation_apa?, retrieval_method?, tags?, relevance_score?", desc: "Add source with auto-APA" },
      ...
      crow_list_sources: { params: "project_id?, source_type?, verified_only?, sort_by?, limit?", desc: "List sources" },
      crow_add_note: { params: "content, note_type?, project_id?, source_id?, title?, tags?", desc: "Add research note" },
      ...
      crow_research_stats: { params: "", desc: "Research statistics" },
    },
  },
