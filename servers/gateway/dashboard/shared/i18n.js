...
export const translations = {
  ...
  "botboard.jsPlanSaved": { en: "Plan saved as a new version.", es: "Plan guardado como una nueva versión." },
  "botboard.jsPlanApproved": { en: "Plan approved.", es: "Plan aprobado." },
  ...
  "botboard.btnApprovePlan": { en: "Approve plan", es: "Aprobar plan" },
  "botboard.planVersionsLabel": { en: "Versions: ", es: "Versiones: " },
  "botboard.planPlaceholder": { en: "(no plan yet)", es: "(sin plan aún)" },
  ...
  "botboard.cfgOpenBtn": { en: "Configure board", es: "Configurar tablero" },
  "botboard.cfgTitle": { en: "Board settings", es: "Ajustes del tablero" },
  "botboard.cfgDisplayName": { en: "Board name", es: "Nombre del tablero" },
  "botboard.cfgStatuses": { en: "Statuses (one per line, in column order)", es: "Estados (uno por l\u00ednea, en orden de columnas)" },
  "botboard.cfgStatusesHelp": { en: "Removing a status that still has cards is refused \u2014 move the cards first.", es: "No se puede quitar un estado que a\u00fan tiene tarjetas \u2014 mueve las tarjetas primero." },
  "botboard.cfgTerminals": { en: "Terminal statuses (stamp completed date)", es: "Estados terminales (marcan fecha de finalizaci\u00f3n)" },
  "botboard.cfgFields": { en: "Fields", es: "Campos" },
  ...
  "board.errArchived": { en: "This card is archived \u2014 unarchive it first.", es: "Esta tarjeta est\u00e1 archivada \u2014 desarch\u00edvala primero." },
  "board.errLocked": { en: "A bot is working this card.", es: "Un bot est\u00e1 trabajando en esta tarjeta." },
  "board.archivedToast": { en: "Archived.", es: "Archivada." },
  "board.unarchivedToast": { en: "Unarchived.", es: "Desarchivada." },
  "board.markerWaiting": { en: "Awaiting review", es: "Pendiente de revisi\u00f3n" },
  "board.markerFailed": { en: "Result failed", es: "Resultado fallido" },
  "board.btnApproveMarkDone": { en: "Approve & mark done", es: "Aprobar y marcar como hecho" },
  "board.btnApproveResult": { en: "Approve", es: "Aprobar" },
  "board.btnRejectResult": { en: "Reject", es: "Rechazar" },
  "board.resultOutcomeSuccess": { en: "success", es: "\u00e9xito" },
  "board.resultOutcomeFailure": { en: "failure", es: "fallo" },
  "board.resultOutcomePartial": { en: "partial", es: "parcial" },
  "board.actorHuman": { en: "you", es: "t\u00fa" },
  "board.actorSession": { en: "session", es: "sesi\u00f3n" },
  "board.noHistory": { en: "No history yet.", es: "A\u00fan no hay historial." },
  "board.mutationVerb.create": { en: "created", es: "creada" },
  "board.mutationVerb.update": { en: "edited", es: "editada" },
  "board.mutationVerb.move": { en: "moved", es: "movida" },
  "board.mutationVerb.archive": { en: "archived", es: "archivada" },
  "board.mutationVerb.unarchive": { en: "unarchived", es: "desarchivada" },
  "board.mutationVerb.plan_save": { en: "plan saved", es: "plan guardado" },
  "board.mutationVerb.plan_approve": { en: "plan approved", es: "plan aprobado" },
  "board.mutationVerb.result_report": { en: "result reported", es: "resultado reportado" },
  "board.mutationVerb.result_decide": { en: "result decided", es: "resultado decidido" },
  ...
  "perch.askSendAnswers": { en: "Send answers", es: "Enviar respuestas" },
  "perch.askSendAnswer": { en: "Send answer", es: "Enviar respuesta" },
  "perch.askSending": { en: "Sending…", es: "Enviando…" },
  "perch.askMultiHint": { en: "(select all that apply)", es: "(seleccione todas las que correspondan)" },
  "perch.askOtherPlaceholder": { en: "Other — type your own answer", es: "Otro — escriba su propia respuesta" },
  ...
  "perch.filesCwdEmpty": { en: "Empty folder", es: "Carpeta vacía" },
  "perch.filesCwdFailed": { en: "Could not load this folder.", es: "No se pudo cargar esta carpeta." },
  "perch.filesNoCwd": {
    en: "This session has no working directory yet.",
    es: "Esta sesión aún no tiene directorio de trabajo.",
  },
  "perch.filesViewerFailed": { en: "Could not open the file.", es: "No se pudo abrir el archivo." },
  "perch.filesViewerUnsupported": {
    en: "Not a viewable text file.",
    es: "No es un archivo de texto visible.",
  },
  "perch.filesViewerTruncated": {
    en: "— truncated (larger than the viewer limit)",
    es: "— truncado (supera el límite del visor)",
  },
