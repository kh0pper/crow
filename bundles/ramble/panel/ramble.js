      ...
      <div id="ramble" data-view="world">
        ...
        <div class="rb-sheet" id="rb-grid-sheet" hidden>
          <div class="rb-sheet-panel" role="dialog" aria-modal="true" aria-labelledby="rb-sheet-title">
            ...
            <p class="rb-muted rb-fine">Strangers see your world name on your marks when Name is pseudonym or real, next to a short key so two people with one name stay apart. Contacts see your Crow name.</p>
