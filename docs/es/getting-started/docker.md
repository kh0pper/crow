...
Define las variables de entorno en un archivo `.env` o pásalas directamente:

```env
# No se necesita configuración de base de datos — Crow usa SQLite local automáticamente.
```
